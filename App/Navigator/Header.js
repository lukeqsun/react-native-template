...
class Header extends React.PureComponent {
    ...
    _renderTitle(props, options) {
        ...
        return this._renderSubView(
            ...
            transitionPreset === 'uikit' ? this.props.titleFromLeftInterpolator : this.props.titleInterpolator
        );
    }
    ...
    _renderModularSubView(props, name, renderer, labelStyleInterpolator, buttonStyleInterpolator) {
        ...
        const ButtonContainer = ({children}) => (
            <Animated.View style={[buttonStyleInterpolator({...this.props, ...props})]}>{children}</Animated.View>
        );

        const LabelContainer = ({children}) => (
            <Animated.View style={[labelStyleInterpolator({...this.props, ...props})]}>{children}</Animated.View>
        );
        ...
        return (
            <View key={`${name}_${key}`} pointerEvents={pointerEvents} style={[styles.item, styles[name], props.style]}>
                {subView}
            </View>
        );
    }
    ...
    render() {
        let appBar;
        const {mode, scene, isLandscape, theme} = this.props;
